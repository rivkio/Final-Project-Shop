    ...
    return (
        <div className="create-card-container bg-purple-900  text-white dark:bg-slate-600">
            ...
            <form noValidate onSubmit={handleSubmit(onSubmit)}>
                ...
                <section>
                    <input placeholder="Title" {...register("productName", { required: "Title is required" })} />
                ...
                <section>
                    <input placeholder="Description" {...register("productDescription", { required: "Description is required" })} />
                ...
                <section>
                    <input
                        placeholder="Category"{...register("price", {
